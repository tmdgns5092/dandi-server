...
FaxService.prototype.getSentListURL= function (CorpNum, UserID, callback, err) {
    this._executeAction({
        uri: '/FAX/?TG=BOX',
        CorpNum: CorpNum,
        UserID: UserID,
...
FaxService.prototype.getSenderNumberMgtURL = function (CorpNum, UserID, callback, err) {
    this._executeAction({
        uri: '/FAX/?TG=SENDER',
        CorpNum: CorpNum,
        UserID: UserID,
